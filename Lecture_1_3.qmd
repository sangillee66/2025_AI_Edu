---
title: |
  | [세 가지 사이언스의 융합과 오픈소스 프로그래밍 2]{style="color:coral;font-size:0.6em"}   
...
# [R과 데이터사이언스 프로세스]{style="color:coral"}
...
## 파이프 연산자(pipe operator): 네이티브(native)
...
## 데이터사이언스 프로세스와 파이프 연산자 {visibility="hidden"}
