---
title: |
  | [오픈소스(R) 프로그래밍 1]{style="color:coral;font-size:0.6em"}   
...
![해들리 위컴 <br> Hadley Wickham <br> Chief Scientist at Posit](https://hadley.nz/hadley.jpg)
:::
...
<kbd style="font-size:2rem">Ctrl</kbd> + <kbd style="font-size:2rem">Shift</kbd> + <kbd style="font-size:2rem">M</kbd>
