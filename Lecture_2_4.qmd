...
```{=html}
<iframe data-external="1" src="https://kosis.kr/edu/share.do?shareID=S0500_16" loading="lazy" style="width: 100%; height: 400px; border: 0px none;" allow="web-share; clipboard-write"></iframe>
```
:::
...
::: {layout-ncol="2"}
![[https://r-spatial.github.io/sf/](https://r-spatial.github.io/sf/){style="font-size:1rem"}](images/hex_sf.png){width="699"}

![[https://rspatial.github.io/terra/](https://rspatial.github.io/terra/){style="font-size:1rem"}](images/hex_terra.png)
:::

## 사례: 전 세계 인구 분포 지도

::: {layout="[45, -10, 45]"}
![[https://ggplot2.tidyverse.org/](https://ggplot2.tidyverse.org/){style="font-size:1rem"}](images/hex_ggplot2-01.png)

![[https://r-tmap.github.io/tmap/](https://r-tmap.github.io/tmap/){style="font-size:1rem"}](images/tmap_1-01.png)
:::
...
![](images/clipboard-216726006.jpeg){fig-align="center"}

## 지리공간적 데이터의 종류

![](images/clipboard-2659758028.png){fig-align="center"}
...
![[https://allisonhorst.com/r-packages-functions](https://allisonhorst.com/r-packages-functions){style="font-size:1rem"}](images/clipboard-601191076.png){fig-align="center"}
...
![[https://datacarpentry.github.io/organization-geospatial/03-crs.html](https://datacarpentry.github.io/organization-geospatial/03-crs.html){style="font-size:1rem"}](https://sangillee.snu.ac.kr/2024_AIEDAP/images/clipboard-215094760.png){fig-align="center"}
...
![](images/clipboard-3706145292.png){fig-align="center"}
...
-   "지도는 지도이다" 관점: 특수성
    ...
    -   [**tmap**](https://r-tmap.github.io/tmap/) 패키지: 4.2.0
    -   웹북: [Spatial Data Visualization with tmap](https://tmap.geocompx.org/)
...
![[https://leafletjs.com/](https://leafletjs.com/){style="font-size:1rem"}](https://sangillee.snu.ac.kr/2024_AIEDAP/images/clipboard-3712927039.png)
