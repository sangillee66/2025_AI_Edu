...
![](https://sangillee.snu.ac.kr/data_science/images/clipboard-1356184653.png){fig-align="center" style="height:700px"}
...
-   **렌더링(rendering) 함수**: 출력 객체 생성 함수, render\*({})
...
## 기본 구조: ui-server 연계 {visibility="hidden"}

-   렌더링 함수와 출력 함수: <https://shiny.posit.co/r/components/>

![](images/clipboard-1333453652.png)

## 기본 구조: ui-server 연계 {.smaller}

-   기본 형식의 출력 함수와 렌더링 함수 쌍

| 형식 | 출력 함수(UI) | 출력 생성(렌더링) 함수(Server) |
|------------------|---------------------------|---------------------------|
